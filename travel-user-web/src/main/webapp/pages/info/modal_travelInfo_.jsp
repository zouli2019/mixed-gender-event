...
<div class="modal fade" id="travelInfoModal" tabindex="-1"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="form-group" id="didDiv">
					<strong><span class="glyphicon glyphicon-eye-open"></span>&nbsp;查看出差详情</strong>
				</div>
			</div>
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="news" href="#contentOne">
									<strong><span class="glyphicon glyphicon-user"></span>&nbsp;出差人员安排（总人数：<span
										id="travel-show_ecount"></span>）</strong>
								</a>
							</h4>
						</div>
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="news" href="#contentTwo">
									...
									</span>&nbsp;出差费用支出项（总费用：￥<span id="allPrice" class="text-danger h2"></span>）
								</strong>
								</a>
							</h4>
						</div>
