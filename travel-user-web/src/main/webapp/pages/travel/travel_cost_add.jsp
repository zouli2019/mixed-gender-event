...
<!-- 内容主体区域 -->
<script src="${basePath}js/pages/travel/travel_cost_add.js"></script>
		...
		<div class="panel-body">
			...
			<div style="width: 100%; margin-top: 20px;">
				<button class="btn btn-danger btn-lg" id="addBtn">
					<span class="glyphicon glyphicon-plus-sign"></span>&nbsp;增加费用项
				</button>
...
<div class="modal fade" id="costInfo" tabindex="-1"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="form-group" id="didDiv">
					<strong><span class="glyphicon glyphicon-eye-open"></span>&nbsp;增加差旅支出申请项</strong>
				</div>
			</div>
			<div class="modal-body">
				<div id="costBasicInfo">
					<form class="form-horizontal" id="costForm" method="post">
